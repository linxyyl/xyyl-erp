...
(1, 'url', '请求FastAdmin', 'https://sbing.vip', '* * * * *', 0, 0, 13548, 1497070825, 1501253101, 1483200000, 3786883200, 1501253101, 1, 'normal'),
(2, 'sql', '查询一条SQL', 'SELECT 1;', '* * * * *', 0, 0, 13548, 1497071095, 1501253101, 1483200000, 3786883200, 1501253101, 2, 'normal'),
(3, 'fun', '执行控制器方法', 'app\api\controller\Demo@test', '* * * * *', 0, 0, 13548, 1497071095, 1501253101, 1483200000, 3786883200, 1501253101, 3, 'normal');
COMMIT;
