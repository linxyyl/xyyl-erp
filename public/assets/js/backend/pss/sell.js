define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'pss.sell/index' + location.search,
                    add_url: 'pss.sell/add',
                    edit_url: 'pss.sell/edit',
                    del_url: 'pss.sell/del',
                    multi_url: 'pss.sell/multi',
                    table: 'sell',
                }
            });
                ...
                columns: [
                    [
...

                        {
                            field: 'company_id',
                            title: __('Company_id') ,
                            searchList:Config.companyList,
                            addclass:'selectpicker',
                            data:'data-live-search="true"',
                            formatter: function (index,row){
                                return Config.companyList[row.company_id];
                            }
                            ...
                            buttons:[
                                // 提交审核按钮
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/submitVerify?id=' + row.id;
                                    },
                                    // 请求成功回调
                                ...
                                // 审核通过按钮
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/confirmVerify?id=' + row.id;
                                    },
                                    // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
                                ...
                                // 复审按钮
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/againVerify?id=' + row.id;
                                    }
                                    ,  // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
                                ...
                                // 确认支付
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/confirmPay?id=' + row.id;
                                    }
                                    ,  // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
                                ...
                                // 取消支付
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/cancelPay?id=' + row.id;
                                    }
                                    ,  // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
                                ...
                                // 审核驳回按钮
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/rejectVerify?id=' + row.id;
                                    }
                                    ,  // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
                                ...
                                // 确认出库按钮
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/confirmPut?id=' + row.id;
                                    }
                                    ,  // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
                                ...
                                // 取消出库按钮
                                {
                                    ...
                                    url: function (row, button) {
                                        return '/admin/pss.Sell/cancelPut?id=' + row.id;
                                    }
                                    ,  // 请求成功回调
                                    success: function (row) {
                                        // 刷新表格
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'pss.sell/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
